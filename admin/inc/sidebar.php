  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?page=dashboard"> <!-- ?page=nama_route_di_content/ , itu buat nandain klo klik nav ini route apa yg di show di master template (main div, di home.php) -->
